...
import com.lws.juzimi.mvp.presenter.impl.AllarticlePresenter;
import com.lws.juzimi.mvp.ui.activity.JujiDetailActivity;
import com.lws.juzimi.mvp.ui.adapter.ArticleAdapter;
import com.lws.juzimi.mvp.ui.view.IAllarticleView;
import com.lws.recyclerviewlibrary.flexibledivider.GridSpacingItemDecoration;
...
import com.lws.recyclerviewlibrary.recyclerview.HeaderSpanSizeLookup;
...
public class AllarticleListFragment extends BaseFragment implements IAllarticleView {
    ...
    public AllarticleListFragment() {
    }

    public static AllarticleListFragment newInstance(String type) {

        AllarticleListFragment fragment = new AllarticleListFragment();
