...
public class JujiFragment extends BaseFragment {
    ...
    private void initControls() {
        ...
        //初始化各fragment
        JujiListFragment jujiListFragment1 = JujiListFragment.newInstance(TYPE1);
        JujiListFragment jujiListFragment2 = JujiListFragment.newInstance(TYPE2);

        //将fragment装进列表中
        List<Fragment> list_fragment = new ArrayList<>();
        list_fragment.add(jujiListFragment1);
        list_fragment.add(jujiListFragment2);
