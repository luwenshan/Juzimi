...
/**
 * Created by Wenshan.Lu on 2016/12/13.
 * <p>
 * 分页展示数据时，Recycler的FooterView State 操作工具箱
 * <p>
...
public class RecyclerViewStateUtils {
    /**
     * 设置HeaderAndFooterRecyclerViewAdapter的FooterView State
     *
     * @param instance      context
     * @param recyclerView  recyclerView
     * @param hasMore       分页展示时，recyclerView每一页的数量
     * @param state         FooterView State
     * @param errorListener FooterView处于Error状态时的点击事件
     */
    public static void setFooterViewState(Activity instance,
    ...
    public static RecyclerViewLoadingFooter.State getFooterViewState(RecyclerView recyclerView) {
        ...
        if (outerAdapter != null && outerAdapter instanceof HeaderAndFooterRecyclerViewAdapter) {
            HeaderAndFooterRecyclerViewAdapter headerAndFooterAdapter = (HeaderAndFooterRecyclerViewAdapter) outerAdapter;
            if (headerAndFooterAdapter.getFooterViewsCount() > 0) {
                RecyclerViewLoadingFooter footerView = (RecyclerViewLoadingFooter) headerAndFooterAdapter.getFooterView();
